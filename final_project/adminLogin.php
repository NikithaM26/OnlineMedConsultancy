  ...
  <body>
    ...
    <div class="login">
      <ul class="nav nav-tabs nav-justified">
        <li class="nav-item">
          <a class="nav-link " href="login.php">USERS</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="login_doc.php">DOCTORS</a>
        </li>
        <li class="nav-item">
...
if($_SERVER['REQUEST_METHOD'] === 'POST')
{
  if(isset($_POST['submit']))
  {
    ...
    $sql1 = "INSERT INTO login (USERNAME,PSWD) VALUES ('$_POST[username]', '$_POST[pswd]')";
